 ...
 */
public class Demography extends JPanel {
	...
	Demography(double[][] dataMedlemmer,double[][] dataStotte,int medlemTotal,int srKvinner,int srMenn,int jrKvinner,int jrMenn) {
